        ...
        controls = Column(
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: Row(
                children: <Widget>[
                  if (!widget.use24HourDials && timeOfDayFormat == TimeOfDayFormat.a_space_h_colon_mm) ...<Widget>[
                    _DayPeriodControl(
                      selectedTime: widget.selectedTime,
      ...
      case Orientation.landscape:
        ...
        controls = Expanded(
          child: Column(
            ...
            children: <Widget>[
              if (!widget.use24HourDials && timeOfDayFormat == TimeOfDayFormat.a_space_h_colon_mm)
                _DayPeriodControl(
                  selectedTime: widget.selectedTime,
                  orientation: widget.orientation,
                  onChanged:widget. onChanged,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
           widget. helpText ?? MaterialLocalizations.of(context).timePickerDialHelpText,
...
class _DialState extends State<_Dial> with SingleTickerProviderStateMixin {
  ...
  dynamic _notifyOnChangedIfNeeded({ bool roundMinutes = false }) {
    final dynamic current = _getTimeForTheta(_theta.value, roundMinutes: roundMinutes);
